...
SubProceso  Alumno = NuevoEstudiante
...
SubProceso Obra = PrestarLibro(libro)
	long <- Longitud(libro)
	j <- long-5
...
SubProceso Devolver = DevolverLibro(libro)
